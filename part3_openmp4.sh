...
do
mpirun --hostfile NEW_HOSTFILE3 -np 4  /homes/mcheikh/CIS_625/hw5/part-3/Part3-MPI-OpenMP 4 $i
mpirun --hostfile NEW_HOSTFILE3 -np 1  /homes/mcheikh/CIS_625/hw5/part-3/Part3-MPI-OpenMP 4 $i 
